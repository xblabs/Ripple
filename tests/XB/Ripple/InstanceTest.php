...
class InstanceTest extends TestCase
{
	...
	public function test_events_dispatch_eventIsEvent(): void
	{
		$listener = Closure::fromCallable( [ $this, 'listenerDefault' ] );
		$this->dispatcher->addListener( 'test', $listener );
		$this->dispatcher->dispatch( new Event( 'test', $this, [ 1, 2 ], false ) );
	...
	public function test_events_getListenersForType(): void
	{
		...
		$this->dispatcher->addListener( 'anotherType', [ $this, 'listenerB' ] );
	...
	{
		$this->dispatcher->addListener( 'test', [ $this, 'listenerA' ], -100 );
		$this->dispatcher->addListener( 'test', [ $this, 'listenerB' ], 100 );
		$result = $this->dispatcher->dispatch( 'test', $this );
		$this->assertCount( 2, $result );
		$this->assertEquals( static::LISTENER_B_RESULT, $result[ 0 ] );
	}
	...
	{
		$this->dispatcher->addListener( 'test', [ $this, 'listenerA' ], 100 );
		$this->dispatcher->addListener( 'test', [ $this, 'listenerB' ], 0 );
		$result = $this->dispatcher->dispatch( 'test', $this );
		$this->assertCount( 2, $result );
		$this->assertEquals( static::LISTENER_A_RESULT, $result[ 0 ] );
	}
	...
	{
		$this->dispatcher->addListener( 'test', [ $this, 'listenerACancel' ], 300 );
		$this->dispatcher->addListener( 'test', [ $this, 'listenerB' ], 100 );
		$result = $this->dispatcher->dispatch( 'test', $this );
	...
	{
		$this->dispatcher->addListener( 'test', [ $this, 'listenerACancel' ], 0 );
		$this->dispatcher->addListener( 'test', [ $this, 'listenerB' ], 100 );
...
//        $listenerTrue2 = Closure::fromCallable( [ $this, 'listenerTrue2' ]  );
	...
	{
		$this->dispatcher->addListener( 'test', [ $this, 'listenerDefault' ] );
		$this->dispatcher->dispatch( 'test', $this, [ 'param1' => new EventTestParam() ] );
	...
	public function test_events_removeSingleListener(): void
	{
		...
		$this->dispatcher->removeListener( 'test', [ $this, 'listenerDefault' ] );
	...
	public function test_event_subscriber(): void
	{
		...
		$this->dispatcher->dispatch( 'test:afterTest', $target, [ 'one' ] );
	...
	{
		$this->dispatcher->addListener( 'test', [ $this, 'listenerA' ] );
		$descriptor = $this->dispatcher->getListenersForEvent( 'test' )[ 0 ];
		$this->assertSame( 0, $descriptor->priority );
	}
